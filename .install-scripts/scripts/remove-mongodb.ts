...
const removeMongoDb = async () => {
  const filesToRemove = [
    ...
    path.join(process.cwd(), 'ops', 'startup', 'startup.document.ci.sh'),
    path.join(process.cwd(), 'ops', 'startup', 'startup.document.dev.sh'),
    path.join(process.cwd(), 'ops', 'startup', 'startup.document.test.sh'),
    path.join(process.cwd(), 'ops', 'docker', 'images', 'document.dev.Dockerfile'),
    path.join(process.cwd(), 'ops', 'docker', 'images', 'document.e2e.Dockerfile'),
    path.join(process.cwd(), 'ops', 'docker', 'images', 'document.test.Dockerfile'),
