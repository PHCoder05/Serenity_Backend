...
const removePostgreSql = async () => {
  const filesToRemove = [
    ...
    path.join(process.cwd(), 'ops', 'startup', 'startup.relational.ci.sh'),
    path.join(process.cwd(), 'ops', 'startup', 'startup.relational.test.sh'),
    path.join(process.cwd(), 'ops', 'startup', 'startup.relational.dev.sh'),
    path.join(
      process.cwd(),
      'ops',
      'docker',
      'images',
      'relational.dev.Dockerfile',
    ),
    path.join(
      process.cwd(),
      'ops',
